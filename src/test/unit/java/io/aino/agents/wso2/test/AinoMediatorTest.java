...
public class AinoMediatorTest {
    ...
    @Test
    public void mediatorUsesAinoLoggerWhenEnabledAndMonitoredTest() throws Exception {
    ...
    @Test
    public void mediatorDoesNotUseAinoLoggerWhenNotMonitoredTest() throws Exception {
